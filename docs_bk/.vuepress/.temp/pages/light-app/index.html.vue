...
<p>该设置，适用于需要做红点提示的应用，例如审批类的轻应用，支持显示<code>红点</code>、<code>数字</code>及<code>图标</code>，具体文档，请查看<a href="/light-app/notify.md" target="_blank" rel="noopener noreferrer">应用红点<OutboundLink/></a>。</p>
...
<p>因为<code>PC客户端</code>默认使用下划线的命名方式设置参数的<code>key</code>值，具体原因可以查看<a href="/light-app/sso.md#pc-%E5%AE%A2%E6%88%B7%E7%AB%AF" target="_blank" rel="noopener noreferrer">单点登录-获取用户信息<OutboundLink/></a>，为了保持一致性，请统一使用下划线的<code>key</code>值，如：</p>
...
<p><code>离线资源包</code>设置是移动端特有，需要上传<code>zip</code>压缩包，并且需要设置相应的<code>启动地址</code>，具体说明，请查看<a href="/light-app/offline.md" target="_blank" rel="noopener noreferrer">离线应用<OutboundLink/></a>。</p>
...
<p>可以根据实际需求，设定不同的模版消息，具体使用方式，请查看<a href="/api/app/template.md" target="_blank" rel="noopener noreferrer">模板消息<OutboundLink/></a>。</p>
