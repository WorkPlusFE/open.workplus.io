...
<p>具体接口使用说明，请查看<a href="/api/auth.md" target="_blank" rel="noopener noreferrer">API文档-单点登录<OutboundLink/></a>。</p>
...
<p>另一种方式，就是通过截取应用启动地址上的参数，具体设置请查看<a href="/light-app/README.md#%E5%90%AF%E5%8A%A8%E5%9C%B0%E5%9D%80" target="_blank" rel="noopener noreferrer">应用启动地址<OutboundLink/></a>。</p>
