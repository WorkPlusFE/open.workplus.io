...
<p><code>access_token</code>的获取方式，请查看 <a href="/api/getStart.md#%E8%8E%B7%E5%8F%96-accesstoken" target="_blank" rel="noopener noreferrer">接入流程-获取 AccessToken<OutboundLink/></a>。</p>
</div>
