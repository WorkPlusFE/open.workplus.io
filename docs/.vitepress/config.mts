...
export default defineConfig({
  title: "BeeWorks Open Website",
  description: "BeeWorks Open Website!",
  lang: 'zh-Hans',
  locales: {
    root: {
      label: 'zh-CN',
      title: 'BeeWorks 开放平台',
      description: 'BeeWorks，企业移动管理平台服务商，专注于为中大型企业提供一站式移动办公新体验。目前已服务的国内外大型企业超过100家，终端用户数量突破500000，为企业提供了移动管理平台，移动门户，移动办公OA，移动审批，会议管理，通知公告，业务系统集成以及企业中台，安全可控等一体化解决方案，支持手机端和pc端，真正实现了企业管理与移动办公的高效性。',
      head: [
        ...
        ['meta', { itemprop: 'name', content: 'BeeWorks - 企业移动办公管理平台,移动门户,移动办公OA,企业办公沟通,智慧办公解决方案专家' }],
  ...
  themeConfig: {
    ...
    footer: {
      message: `<div class="footer__links" style="padding-bottom: 8px">
        <a class="footer__link-item" target="_blank" href="https://www.beeworks.cn/">公司官网</a>
    ...
    nav: [
    {
      ...
      text: '了解更多',
      items: [
        { text: 'BeeWorks 官网', link: 'https://www.beeworks.cn/' },
        { text: 'Cordova 原始文档', link: 'https://open.beeworks.cn/cordova/' },
      ]
    }],
