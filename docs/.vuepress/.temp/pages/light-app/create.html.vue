<template><h1 id="添加内部应用" tabindex="-1"><a class="header-anchor" href="#添加内部应用" aria-hidden="true">#</a> 添加内部应用</h1>
<div class="custom-container tip"><p class="custom-container-title">阅读本文，你将了解：</p>
<ul>
<li>如何在平台上发布应用及设置使用权限和入口等；</li>
<li>如何设置应用红点数字提醒、自定义头部等；</li>
</ul>
<p>本文主要围绕上架<code>轻应用</code>来描述，其他类型应用在设置上也大同小异。</p>
</div>
<p>登录管理后台，选择并进入对应的组织，然后点击<code>应用管理</code>菜单，从右上角的<code>添加</code>按钮，选择<code>内部应用</code>，即可进入创建内部应用的界面。</p>
<h2 id="基本信息" tabindex="-1"><a class="header-anchor" href="#基本信息" aria-hidden="true">#</a> 基本信息</h2>
<p>如下图，带红星的字段表示必填，如果没有<code>应用分类</code>，点击<code>创建分类</code>进行创建即可。</p>
<p class="w6s-image">
  <img :src="$withBase('/app/base1.png')" alt="基本信息" width="600">
</p>
<h2 id="应用类型" tabindex="-1"><a class="header-anchor" href="#应用类型" aria-hidden="true">#</a> 应用类型</h2>
<p>当前支持上架的应用类型包括：<code>轻应用</code>、<code>服务号</code>及<code>原生应用</code>。</p>
<h3 id="轻应用" tabindex="-1"><a class="header-anchor" href="#轻应用" aria-hidden="true">#</a> 轻应用</h3>
<p>H5 网页应用，也是 WorkPlus 移动平台上主要的应用类型，可通过 JS-SDK 调用原生能力，并支持多种自定义配置，是业务系统快速移动化的重要手段。</p>
<h3 id="服务号" tabindex="-1"><a class="header-anchor" href="#服务号" aria-hidden="true">#</a> 服务号</h3>
<p>类似微信的“公众号”，属于应用的一种类型。创建该类型的应用，需要单独访问服务号“应用后台”进行配置，例如设置“关键字自动回复”，自定义“服务号菜单”等。</p>
<p class="w6s-image">
  <img :src="$withBase('/app/serverNo.png')" alt="服务号" width="600">
</p>
<h3 id="原生应用" tabindex="-1"><a class="header-anchor" href="#原生应用" aria-hidden="true">#</a> 原生应用</h3>
<p>在 WorkPlus 应用中心上架原生应用，大多设置跟轻应用类似，只是入口需要上传相应安装包或者指定某个系统级别应用。</p>
<p>更多说明，请查看<RouterLink to="/light-app/nativeApp.html">上架原生应用</RouterLink>。</p>
<h2 id="应用入口" tabindex="-1"><a class="header-anchor" href="#应用入口" aria-hidden="true">#</a> 应用入口</h2>
<p>如下图，创建应用时，需要直接填写“应用主入口”的信息，包括“名称”、“图标”和“启动地址”等。</p>
<p class="w6s-image">
  <img :src="$withBase('/app/base2.png')" alt="启动地址" width="600">
</p>
<p>目前提供3个平台的设置，包括<code>苹果</code>、<code>安卓</code>及<code>PC客户端</code>，其中<code>苹果</code>和<code>安卓</code>的设置是一样，而<code>PC客户端</code>的相对少一些。以下是各字段的各端支持说明：</p>
<table>
<thead>
<tr>
<th>字段名</th>
...
<p>在较新版本，一些移动端独有的设置，统一归类到“移动端更多设置”上，可访问<RouterLink to="/light-app/create.html#%E7%A7%BB%E5%8A%A8%E7%AB%AF%E8%AE%BE%E7%BD%AE">移动端设置</RouterLink>了解更多。</p>
</div>
<h3 id="红点数字提醒源" tabindex="-1"><a class="header-anchor" href="#红点数字提醒源" aria-hidden="true">#</a> 红点数字提醒源</h3>
...
<h3 id="启动地址" tabindex="-1"><a class="header-anchor" href="#启动地址" aria-hidden="true">#</a> 启动地址</h3>
...
<h3 id="离线资源包" tabindex="-1"><a class="header-anchor" href="#离线资源包" aria-hidden="true">#</a> 离线资源包</h3>
...
<h2 id="移动端设置" tabindex="-1"><a class="header-anchor" href="#移动端设置" aria-hidden="true">#</a> 移动端设置</h2>
<p>点击“移动端更多设置”，即可展开该设置页面。相关设置主要提供移动端 WebView 头部自定义的能力。</p>
<p class="w6s-image">
  <img :src="$withBase('/app/mobile-more.png')" alt="移动端设置" width="600">
</p>
<h3 id="应用参数设置" tabindex="-1"><a class="header-anchor" href="#应用参数设置" aria-hidden="true">#</a> 应用参数设置</h3>
...
<h3 id="沉浸式" tabindex="-1"><a class="header-anchor" href="#沉浸式" aria-hidden="true">#</a> 沉浸式</h3>
<p>在一些门户级别，或者页面顶部有大图展示的应用，在“沉浸式”的模式下，表现力会更强。</p>
<p>若想开启“沉浸式”头部，需要先勾选“全屏”设置。开启后，页面的可访问区域将会延伸到手机顶部，此时需要留意页面的安全区域问题。</p>
<blockquote>
<p>系统版本低于 5.0 的安卓机型，不完全能支持“沉浸式”功能。</p>
</blockquote>
<h2 id="应用权限" tabindex="-1"><a class="header-anchor" href="#应用权限" aria-hidden="true">#</a> 应用权限</h2>
...
<h2 id="创建应用入口" tabindex="-1"><a class="header-anchor" href="#创建应用入口" aria-hidden="true">#</a> 创建应用入口</h2>
...
<h2 id="消息模版" tabindex="-1"><a class="header-anchor" href="#消息模版" aria-hidden="true">#</a> 消息模版</h2>
