...
<h2 id="压缩包规范" tabindex="-1"><a class="header-anchor" href="#压缩包规范" aria-hidden="true">#</a> 压缩包规范</h2>
...
<div class="custom-container tip"><p class="custom-container-title">离线包外部备用地址</p>
<p>除了在平台上传资源包外，还可以设置<code>离线包外部备用地址</code>，地址为一个在线可访问的资源地址，压缩包的规范需要保持一致。当设置了离线包外部备用地址时，客户端会优先使用该地址下载离线资源。</p>
<p>为了提高资源包的下载速度，可以配合 CDN 来设置该备用地址。</p>
</div>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>local<span class="token operator">:</span><span class="token operator">/</span><span class="token operator">/</span>mobile<span class="token operator">/</span>index<span class="token punctuation">.</span>html
